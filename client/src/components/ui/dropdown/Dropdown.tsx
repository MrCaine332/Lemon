...
export const Dropdown = ({
	...
	const buttonElement = React.cloneElement(children[0], {
		...
		onClick: (event: MouseEvent) => {
			...
			const newIsOpened = forceIsOpened === undefined
				? !isOpened
				: !forceIsOpened
			if (forceIsOpened === undefined)
	...
	return (
		<div className={[styles.dropdownWrap, wrapperClassName].join(' ')} ref={ref}>
			{ buttonElement }
			<Section className={[
				styles.dropdown,
				forceIsOpened === undefined
					? isOpened ? styles.dropdown_show : ''
					: forceIsOpened ? styles.dropdown_show : '',
				dropdownClassName
			].join(' ')}>
				{ children[1] }
			</Section>
