    ...
    <Section className={styles.authorWrapper}>
      ...
      <div className={styles.author}>
        ...
        <div className={styles.authorBody}>
          <h4 className={"textHeader3 " + styles.authorBodyTitle}>
            About Lemon
          </h4>
          <p className={"textBody"}>
            Over the fifteen-year life span of Food.com, we’ve learned that – in
            addition to eating – sharing is what you do best. And thanks to the
            20 million of you who come here each month, we now have 500,000
            recipes to show for it, more than anywhere else in the digital
            universe. We also have tons crazy-tempting photos, troves of recipe
            reviews and more than 2 million Facebook likes. That’s a heck of a
            lot of Food. Thank you!
          </p>
