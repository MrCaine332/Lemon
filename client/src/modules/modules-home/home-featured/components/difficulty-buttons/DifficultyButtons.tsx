...
export const DifficultyButtons = ({ difficulty, setDifficulty }: DifficultyButtonsProps) => {
	return (
		<div className={styles.homeRecipesButtons}>
			<Button onClick={() => setDifficulty(Difficulty.easy)}
			        className={difficulty === Difficulty.easy ? styles.buttonActive : ''}
			>
				EASY
			</Button>
			<Button onClick={() => setDifficulty(Difficulty.medium)}
			        className={difficulty === Difficulty.medium ? styles.buttonActive : ''}
			>
				MEDIUM
			</Button>
			<Button onClick={() => setDifficulty(Difficulty.hard)}
