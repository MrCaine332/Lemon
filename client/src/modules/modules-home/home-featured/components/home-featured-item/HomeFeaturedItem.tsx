...
export const HomeFeaturedItem = ({ recipe }: HomeRecipesItemProps) => {
	...
	return (
		<Link to={'/recipe/:' + recipe.id} className={styles.homeFeaturedItemWrapper}>
			<div className={styles.homeFeaturedItem}>
				...
				<div className={styles.homeFeatureItemInfo}>
					<h3 className={'textHeader3 ' + styles.homeFeaturedItemTitle}> {recipe.title} </h3>
					<p className={'textBody ' + styles.homeFeaturedItemDescription}>{recipe.description}</p>
